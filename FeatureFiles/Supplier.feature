...
When Wait For Supplier with "xpath" and"(//a[.='Suppliers'])[2]"
When Click On Supplier with "xpath" and "(//a[.='Suppliers'])[2]"
...
When Wait For Alert with "xpath" and "(//button[contains(.,'OK')])[6]"
When Click On Alert with "xpath" and "(//button[contains(.,'OK')])[6]"
